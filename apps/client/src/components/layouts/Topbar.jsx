...
function Topbar() {
  ...
  return (
    <div className="flex min-h-[4.75rem] w-full items-center justify-end border-b border-[#0f0f0f] bg-[#0f0f0f] px-4 sm:px-5">
      <div className="hidden text-sm md:block text-base-content/60">
      </div>

      <div className="flex min-w-0 items-center gap-2 sm:gap-3 md:gap-4">
        <div className="flex max-w-[10rem] items-center gap-2 rounded-full border border-[#0cf33a] bg-[#19291c] px-2.5 py-2 text-[#0cf33a] sm:max-w-[14rem] sm:px-3 md:max-w-none">
